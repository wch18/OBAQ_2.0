...
class OptimRegime(object):
    ...
    def __init__(self, params, regime, warmup_epochs=1, total_iters=391):
        ...
        print(self.total_iters, self.regime, self.warmup_epochs)
    def update(self, epoch, train_steps):
        ...
        if epoch < self.warmup_epochs:
            setting['lr'] = base_lr * train_steps / self.warmup_epochs / (self.total_iters + 1e-8)
            update_optimizer = True
        elif 'lr_decay_rate' in setting and 'lr' in setting:
